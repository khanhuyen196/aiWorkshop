...
3. Task 3: Open AI-Assisted Application Project. You may either create a new application or continue improving the CLI application from the workshop. If you choose the CLI continuation path, each student should add at least one new feature.[task 3 - open ai assisted application](task3-yourOwnIdea/README.md)
